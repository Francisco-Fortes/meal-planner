...
// const initialState = {
//   cart: {
//     // this is technically called a "slice" of the Redux Store
//     content: [], // we're going to put our books here!
//   },
//   // so I need now to prepare a place for storing the user's username
//   // since it does not belong to the cart "slice", let's create a new one
...
//       return {
//         ...state, // this will make sure the user slice won't disappear!
//         cart: {
//           ...state.cart,
